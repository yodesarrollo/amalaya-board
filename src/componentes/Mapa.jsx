            ...
            {espacios.map((e) => {
              ...
              if (!modoEdicion) {
                ...
                return (
                  ...
                  >
                    {cara?.file_id ? (
                      /* La cara del representante + la insignia del tipo:
                         una no borra a la otra */
                      <span className="relative block">
                        <span className={`block w-12 h-12 rounded-full overflow-hidden border-2 shadow-lg bg-noche
                        ...
                        <span className={`absolute -bottom-1 -right-1.5 w-6 h-6 rounded-full flex items-center justify-center border shadow
