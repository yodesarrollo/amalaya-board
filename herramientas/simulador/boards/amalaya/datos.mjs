...
export const datos={
 ...
 Finanzas_Lineas:[
  ...
  L('L-010','E-001','Patrocinio base','ingreso','1500000','1 marca ancla','ESC-001'),
  L('L-011','E-001','Patrocinio ampliado','ingreso','4200000','3 marcas','ESC-002')],
 Escenarios:[{id:'ESC-001',espacio_id:'E-001',nombre:'110 eventos',activo:'si',notas:''},{id:'ESC-002',espacio_id:'E-001',nombre:'150 eventos',activo:'no',notas:''}],
 ...
 Paradas:[{id:'P-001',ruta_id:'R-001',nombre:'Guerrero y Serdán',foto_actual_id:'local:../mapa-poligono.jpg',foto_vision_id:'local:../lamina-zona-nucleo.jpg',elementos:JSON.stringify([{texto:'Banquetas amplias',estado:'gestionado'},{texto:'Arbolado',estado:'pendiente'},{texto:'Alumbrado',estado:'logrado'}]),notas:'',orden:'1',pos_x:'54',pos_y:'28'},
